...
INSERT INTO tickets (event_id, type, is_free, price, total_ticket, sold_ticket)
VALUES
(1, 'REGULAR', false, 15.0, 30, 20),
(1, 'VIP', true, 0.0, 20, 10);

-- Inserting tickets for Event ID 2 (Regular)
INSERT INTO tickets (event_id, type, is_free, price, total_ticket, sold_ticket)
VALUES
(2, 'REGULAR', false, 10.0, 100, 100);

-- Inserting tickets for Event ID 3 (VIP)
INSERT INTO tickets (event_id, type, is_free, price, total_ticket, sold_ticket)
VALUES
(3, 'VIP', false, 20.0, 50, 50);

-- Inserting tickets for Event ID 4 (Regular + VIP)
INSERT INTO tickets (event_id, type, is_free, price, total_ticket, sold_ticket)
VALUES
(4, 'REGULAR', false, 10.0, 50, 25),
(4, 'VIP', false, 30.0, 50, 50);

-- Inserting tickets for Event ID 5 (Regular, VIP, and none)
INSERT INTO tickets (event_id, type, is_free, price, total_ticket, sold_ticket)
VALUES
(5, 'REGULAR', false, 10.0, 80, 40),
(5, 'VIP', false, 30.0, 80, 0);

-- Inserting tickets for Event ID 6 (No tickets available)
INSERT INTO tickets (event_id, type, is_free, price, total_ticket, sold_ticket)
VALUES
(6, 'VIP', true, 0.0, 20, 20);

-- Inserting tickets for Event ID 7 (Regular)
INSERT INTO tickets (event_id, type, is_free, price, total_ticket, sold_ticket)
VALUES
(7, 'REGULAR', false, 10.0, 120, 60);

-- Inserting tickets for Event ID 8 (VIP)
INSERT INTO tickets (event_id, type, is_free, price, total_ticket, sold_ticket)
VALUES
(8, 'VIP', false, 25.0, 100, 100);